...
<template>
    <div class="config">
        <div class="config-header">
            ...
            <button class="config-header-btn" @click="handleSave">
                    ...
                    <div class="config-card">
                        ...
                        <div class="config-grid">
                            <div class="config-field">
                                ...
                                <input v-model="empresa.name" type="text" class="config-input" />
                            </div>
                            <div class="config-field">
                                <label class="config-label">CIF / NIF</label>
                                <input v-model="empresa.cif" type="text" class="config-input" />
                            </div>
                        </div>
                        <div class="config-field">
                            <label class="config-label">Dirección Principal</label>
                            <input v-model="empresa.address" type="text" class="config-input" />
                        </div>
                    </div>
                    ...
                    <div class="config-card">
                        ...
                        <div class="config-grid">
                            <div class="config-field">
                                ...
                                <select v-model="empresa.incoterm" class="config-select">
                            ...
                            <div class="config-field">
                                ...
                                <select v-model="empresa.currency" class="config-select">
